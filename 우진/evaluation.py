    ...
    def result(self , option = 'all',f1_score_option = 'macro'):
        ...
        if option == 'all':
            ...
            for i in range(self.num_classes):
                label_accs.append(self.correct_num[i] / self.total_num[i])
            return label_accs ,accuracy_score(self.preds, self.labels), f1_score(self.preds, self.labels, average = f1_score_option)      